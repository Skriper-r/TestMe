...
class WebTablePage(BasePage):
    ...
    def add_new_person(self):
        ...
        while count != 0:
            ...
            deparment = person_info.department
            ...
            self.element_is_visible(self.locators.DEPARTMENT_INPUT).send_keys(deparment)
            self.element_is_visible(self.locators.SUBMIT).click()
            count -= 1
            return [firstname, lastname, str(age), email, str(salary), deparment]
